...
struct grug_internal_arena_block {
    // the full size of this block. Will be a multiple of the block size.
    size_t total_size;
    // null for the last block
    struct grug_internal_arena_block* next;
};

struct grug_internal_arena {
    ...
    struct grug_internal_arena_block* blocks;
    ...
    struct grug_internal_arena_block* empty_blocks;
